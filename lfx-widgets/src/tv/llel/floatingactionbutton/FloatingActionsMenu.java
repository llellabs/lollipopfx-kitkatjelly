...
public class FloatingActionsMenu extends ViewGroup {
  ...
  public AnimatorSet mExpandAnimation = new AnimatorSet().setDuration(ANIMATION_DURATION);
  public AnimatorSet mCollapseAnimation = new AnimatorSet().setDuration(ANIMATION_DURATION);
